...
#
# # os.rmdir("子目录4") ???
# # path = "/Users/FOX/Desktop/根目录/子目录1/子目录2/"
# # li=os.listdir(path)
# # for i in li:
# #     print bytes(i)
#
...
# # print os.path.dirname(os.curdir),os.name,os.environ
# # print os.path.split("-.py")
#
# # file = "-.py"
# # print os.path.abspath(file),os.path.getsize(file)
#
#
# # import sys
# # print sys.argv
# # print sys.maxint**2,sys.platform
#
#
# import sys,time
# for i in range(60):
...
# # f = open("newhello","w")
# # f.write(date)
# # # print date,type(date),type(json.dumps(id))
#
#
# f = open("newhello","r")
